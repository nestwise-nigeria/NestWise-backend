...
const registerUser = async(req, res) => {
    try{
        const { firstname, lastname, email, phone, role, password, nationality, dob, idType, idNumber, idPicture } = req.body
        const response = await authServices.newUser(firstname, lastname, email, phone, role, password, nationality, dob, idType, idNumber, idPicture);
